...
(function() {
  ...
  exports.factory = {
    unitSquare: function() {
      return new polygon([new vector.vector(0.5, 0.5), new vector.vector(-0.5, 0.5), new vector.vector(-0.5, -0.5), new vector.vector(0.5, -0.5)]);
    },
